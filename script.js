// ============================================================
// Australian by Design — 画面切り替え（バニラ JavaScript）
// このファイルの仕事：ボタンを押したら、見せる画面を変えるだけ
// ============================================================
...
// ============================================================
// ■ このファイルでやっていること
//   5つの <section>（画面）のうち、1つだけ class で表示する。
//
// ■ showScreen の流れ
//   1. すべての .screen から screen--active を外す
//   2. 指定 id の section だけ screen--active を付ける
//   3. CSS が .screen--active だけ display: block にする
//
// ■ wireButton / wireButtonsByClass
//   同じパターンの addEventListener を何度も書かないための
//   小さなヘルパー。中身は「クリック → showScreen(行き先)」だけ。
//
// ■ カートの合計（$60 + $11 = $71）
//   数字は HTML に書いてある。JavaScript は計算していない。
//
// ■ チューターへの説明例
//   "I use one HTML page with five sections. showScreen hides all
//    sections then shows one by adding a CSS class. No React or router."
// ============================================================
